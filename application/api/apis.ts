...
let req= await AxiosInstance.post("/api/subscription",{
...
export const processSummary = async (docid: String, prompt: String,isText:String) => {
    ...
    const response = await fetch(`${APP_URL}/${isText.length<1?"summary":"text-summary"}`, {
        method: 'POST',
        headers: headers,
